    ...
    <div class="wrap">
        <div class="hero-grid">
            <div class="eyebrow-free reveal">
                ...
                <p class="lead">Dari kendaraan, kamera, ruang acara, sampai jasa teknisi dan guide — cek ketersediaan,
                    booking,
            ...
            <div class="hero-collage reveal reveal-delay-1">
                <div class="ph ph1"
                    style="background-image:url('<?= esc(catFoto('ruang-villa', $categoryPhotos)) ?>');"></div>
                <div class="ph ph2" style="background-image:url('<?= esc(catFoto('kendaraan', $categoryPhotos)) ?>');">
                </div>
                <div class="ph ph3"
...
<section id="kategori">
    <div class="wrap">
        <div class="section-head-row reveal">
            ...
            <a href="<?= base_url('/catalog') ?>" class="btn btn-outline">Lihat semua kategori</a>
        </div>
        <div class="card-grid">
